...
public class FtpPools implements Consoleable {
	private static Map<String, XFtp> CASH = new Hashtable();
	public static Map<String, Class<? extends XFtp>> FTP_MAP = new LinkedHashMap();
	...
	public XFtp getNewFtp() {
		XFtp xftp = null;
		Class<? extends XFtp> xftpcls = (Class) FTP_MAP.get(this.conf.getServerType());
		if (xftpcls == null) {
	...
	public void disconnectAll() {
		Set<Map.Entry<String, XFtp>> entrySet = CASH.entrySet();
		for (Map.Entry<String, XFtp> entry : entrySet) {
			try {
