...
/*     */   implements XFtp
/*     */ {
/*  37 */   FtpExchangeOutputStream ftpExchangeOutputStream = null;
/*  38 */   private FTPClient ftpclient = null;
/*     */   private String host;
/*     */   private int port;
...
/*     */   
/*     */   public MyFtp() {
/*  45 */     this.ftpclient = myInstance();
/*     */   }
/*     */   
/*     */   protected FTPClient myInstance()
/*     */   {
/*  50 */     return new FTPClient();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     try
/*     */     {
/*  59 */       this.ftpExchangeOutputStream.setListenStr(new StringBuffer());
/*  60 */       boolean isOk = this.ftpclient.changeWorkingDirectory(iso88591(directory));
/*  61 */       if (!isOk)
/*     */       {
/*  63 */         String reseason = this.ftpExchangeOutputStream.getListenStr().toString();
/*  64 */         this.ftpExchangeOutputStream.setListenStr(null);
/*  65 */         if (reseason.toLowerCase().indexOf("No such file or directory".toLowerCase()) >= 0)
/*     */         {
/*  67 */           throw new FtpNoSuchFileException(reseason);
/*     */         }
/*  69 */         if (reseason.toLowerCase().indexOf("550".toLowerCase()) > 0)
/*     */         {
/*  71 */           throw new FtpNoSuchFileException(reseason);
/*     */         }
/*     */         
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*  81 */         throw new FtpCDFailedException(directory + " change failed." + reseason);
/*     */       }
/*     */     }
/*     */     catch (FTPConnectionClosedException e)
/*     */     {
/*  86 */       throw new FtpConnectClosedException(e.getMessage(), e);
/*     */     }
/*     */     catch (IOException e) {
/*  89 */       throw new FtpIOException("cd " + directory + " error!" + e.getMessage(), e);
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/*     */     try {
/*  96 */       if (directory.length() != 0)
/*     */       {
/*  98 */         cd(directory);
/*     */       }
/*     */     } catch (FtpNoSuchFileException localFtpNoSuchFileException) {
/*     */       try {
/* 102 */         mkdirs(directory);
/*     */       } catch (IOException e1) {
/* 104 */         throw new FtpIOException("mkdirs " + directory + " fail!" + e1, e1);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */     throws IOException
/*     */   {
/* 121 */     String[] dirs = directory.split("/");
/*     */     
/*     */ 
/* 124 */     List<String> plist = new ArrayList();
/* 125 */     for (int i = 0; i < dirs.length; i++)
/*     */     {
/* 127 */       String path = "/";
/* 128 */       for (int j = 0; j <= i; j++)
/*     */       {
/* 130 */         if (dirs[j].length() != 0)
/* 131 */           path = path + dirs[j] + "/";
/*     */       }
/* 133 */       plist.add(path);
/*     */     }
/*     */     
/*     */ 
/* 137 */     int i = 0;
/* 138 */     for (i = plist.size() - 1; i >= 0; i--) {
/*     */       try
/*     */       {
/* 141 */         cd((String)plist.get(i));
/*     */       }
/*     */       catch (FtpNoSuchFileException localFtpNoSuchFileException) {}
/*     */     }
/*     */     
...
/*     */ 
/* 148 */     i++;
/* 149 */     for (; i < plist.size(); i++)
/*     */     {
/* 151 */       String dir = (String)plist.get(i);
/* 152 */       this.ftpclient.makeDirectory(iso88591(dir));
/* 153 */       cd(dir);
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/* 170 */     return StringUtil.iso88591(str, this.encode);
/*     */   }
/*     */   
/*     */   private String gbfrom88591(String str) {
/*     */     try {
/* 175 */       return new String(str.getBytes("iso-8859-1"), this.encode);
...
/*     */   public void connect() {
/*     */     try {
/* 183 */       int serverTimeout = PluginUtil.getServerTimeout();
/* 184 */       this.ftpclient.setDefaultTimeout(serverTimeout);
/* 185 */       this.ftpclient.setConnectTimeout(serverTimeout);
/* 186 */       this.ftpclient.setDataTimeout(serverTimeout);
/* 187 */       this.ftpExchangeOutputStream = new FtpExchangeOutputStream(LogUtil.initSexftpChangeConsole(), this.encode);
/* 188 */       this.ftpExchangeOutputStream.setPreStr(String.format("%s:%d@%s", new Object[] { this.host, Integer.valueOf(this.port), this.username }));
/* 189 */       this.ftpclient.addProtocolCommandListener(new PrintCommandListener(this.ftpExchangeOutputStream, true));
/* 190 */       this.ftpclient.connect(this.host, this.port);
/* 191 */       if (!FTPReply.isPositiveCompletion(this.ftpclient.getReplyCode())) {
/* 192 */         this.ftpclient.disconnect();
/* 193 */         return;
/*     */       }
/* 195 */       boolean loginSuc = this.ftpclient.login(this.username, this.password);
/* 196 */       if (!loginSuc)
/*     */       {
/* 198 */         throw new FtpIOException(String.format("Login Failed Using %s : %s!", new Object[] { this.username, this.password }));
/*     */       }
/* 200 */       this.ftpclient.setFileType(2);
/* 201 */       this.ftpclient.enterLocalPassiveMode();
/*     */       
/*     */ 
/* 204 */       LogUtil.info("connected.");
/*     */     } catch (Exception e) {
/* 206 */       disconnect();
/* 207 */       throw new FtpIOException(e);
/*     */     }
/*     */   }
/*     */   
/*     */ 
/*     */ 
/*     */ 
/* 214 */   private String encode = "gbk";
/*     */   
/* 216 */   public void prepareConnect(String host, int port, String username, String password, String encode) { this.host = host;
/* 217 */     this.port = port;
/* 218 */     this.password = password;
/* 219 */     this.username = username;
/* 220 */     this.encode = (encode != null ? encode : "gbk");
/*     */   }
/*     */   
/*     */   public void delete(String deleteFile) {
/*     */     try {
/* 225 */       this.ftpclient.deleteFile(deleteFile);
/*     */     } catch (IOException e) {
/* 227 */       throw new FtpIOException("delete " + deleteFile + " fail!" + e, e);
/*     */     }
/*     */   }
/*     */   
/*     */   /* Error */
...
/*     */     // Byte code:
/*     */     //   0: aload_0
/*     */     //   1: getfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   4: invokevirtual 312	org/apache/commons/net/ftp/FTPClient:logout	()Z
/*     */     //   7: pop
/*     */     //   8: goto +4 -> 12
/*     */     //   11: pop
/*     */     //   12: aload_0
/*     */     //   13: getfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   16: invokevirtual 274	org/apache/commons/net/ftp/FTPClient:disconnect	()V
/*     */     //   19: goto +38 -> 57
/*     */     //   22: pop
/*     */     //   23: aload_0
/*     */     //   24: aload_0
/*     */     //   25: invokevirtual 31	org/sexftp/core/ftp/MyFtp:myInstance	()Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   28: putfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   31: ldc_w 316
...
/*     */     //   41: aload_0
/*     */     //   42: aload_0
/*     */     //   43: invokevirtual 31	org/sexftp/core/ftp/MyFtp:myInstance	()Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   46: putfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   49: ldc_w 316
...
/*     */     //   57: aload_0
/*     */     //   58: aload_0
/*     */     //   59: invokevirtual 31	org/sexftp/core/ftp/MyFtp:myInstance	()Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   62: putfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   65: ldc_w 316
...
/*     */     //   80: astore 8
/*     */     //   82: aload_0
/*     */     //   83: getfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   86: aload_0
/*     */     //   87: aload_1
/*     */     //   88: invokespecial 53	org/sexftp/core/ftp/MyFtp:iso88591	(Ljava/lang/String;)Ljava/lang/String;
/*     */     //   91: invokevirtual 341	org/apache/commons/net/ftp/FTPClient:retrieveFileStream	(Ljava/lang/String;)Ljava/io/InputStream;
/*     */     //   94: astore 4
/*     */     //   96: aload 4
/*     */     //   98: ifnonnull +31 -> 129
...
/*     */     //   108: dup
/*     */     //   109: aload_1
/*     */     //   110: invokestatic 90	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
/*     */     //   113: invokespecial 94	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
/*     */     //   116: ldc_w 347
...
/*     */     //   125: invokespecial 349	org/sexftp/core/exceptions/NeedRetryException:<init>	(Ljava/lang/String;)V
/*     */     //   128: athrow
/*     */     //   129: new 350	java/io/FileOutputStream
/*     */     //   132: dup
/*     */     //   133: aload_2
/*     */     //   134: invokespecial 352	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
/*     */     //   137: astore 5
/*     */     //   139: iconst_0
/*     */     //   140: istore 9
/*     */     //   142: sipush 1024
...
/*     */     //   176: dup
/*     */     //   177: ldc_w 359
/*     */     //   180: invokespecial 94	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
/*     */     //   183: iload 6
/*     */     //   185: invokevirtual 361	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
/*     */     //   188: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
/*     */     //   191: invokespecial 364	java/lang/RuntimeException:<init>	(Ljava/lang/String;)V
/*     */     //   194: athrow
/*     */     //   195: iload 6
/*     */     //   197: iload 11
/*     */     //   199: iadd
...
/*     */     //   236: dup
/*     */     //   237: ldc_w 377
/*     */     //   240: invokespecial 94	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
/*     */     //   243: aload_1
/*     */     //   244: aload 7
...
/*     */     //   258: dup
/*     */     //   259: aload_1
/*     */     //   260: invokestatic 90	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
/*     */     //   263: invokespecial 94	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
/*     */     //   266: ldc_w 382
/*     */     //   269: invokevirtual 97	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
...
/*     */     //   289: invokevirtual 97	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
/*     */     //   292: ldc_w 384
...
/*     */     //   336: dup
/*     */     //   337: ldc_w 389
/*     */     //   340: invokespecial 94	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
/*     */     //   343: iload 6
/*     */     //   345: i2l
/*     */     //   346: invokestatic 391	org/sexftp/core/utils/StringUtil:getHumanSize	(J)Ljava/lang/String;
/*     */     //   349: invokevirtual 97	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
/*     */     //   352: aload 7
/*     */     //   354: invokevirtual 144	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
/*     */     //   357: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
/*     */     //   360: aload 7
/*     */     //   362: invokespecial 122	org/sexftp/core/exceptions/FtpIOException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
/*     */     //   365: athrow
/*     */     //   366: astore 12
/*     */     //   368: aload 4
/*     */     //   370: ifnull +12 -> 382
...
/*     */     //   390: pop
/*     */     //   391: aload_0
/*     */     //   392: getfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   395: invokevirtual 399	org/apache/commons/net/ftp/FTPClient:isConnected	()Z
/*     */     //   398: ifeq +15 -> 413
/*     */     //   401: aload_0
/*     */     //   402: getfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   405: invokevirtual 402	org/apache/commons/net/ftp/FTPClient:completePendingCommand	()Z
/*     */     //   408: pop
/*     */     //   409: goto +4 -> 413
/*     */     //   412: pop
/*     */     //   413: aload 12
...
/*     */     //   438: pop
/*     */     //   439: aload_0
/*     */     //   440: getfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   443: invokevirtual 399	org/apache/commons/net/ftp/FTPClient:isConnected	()Z
/*     */     //   446: ifeq +15 -> 461
/*     */     //   449: aload_0
/*     */     //   450: getfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   453: invokevirtual 402	org/apache/commons/net/ftp/FTPClient:completePendingCommand	()Z
/*     */     //   456: pop
/*     */     //   457: goto +4 -> 461
/*     */     //   460: pop
/*     */     //   461: return
...
/*     */   {
/* 320 */     if (this.ftpclient.isConnected())
/*     */     {
/*     */       try {
/* 323 */         this.ftpclient.noop();
/* 324 */         return true;
/*     */ 
/*     */ 
/*     */ 
/*     */       }
/*     */       catch (FTPConnectionClosedException localFTPConnectionClosedException) {}catch (SocketException localSocketException) {}catch (IOException e)
/*     */       {
/*     */ 
/*     */ 
/* 333 */         throw new FtpIOException(e);
/*     */       }
/* 335 */       disconnect();
/*     */     }
/* 337 */     return false;
...
/* 341 */     List<FtpFile> ftpfileLIst = new ArrayList();
/*     */     
/*     */     try
/*     */     {
/* 345 */       FTPFile[] listFiles = this.ftpclient.listFiles();
/* 346 */       FTPFile[] arrayOfFTPFile1; int j = (arrayOfFTPFile1 = listFiles).length; for (int i = 0; i < j; i++) { FTPFile ftpFile = arrayOfFTPFile1[i];
/*     */         
/* 348 */         if ((!".".equals(ftpFile.getName())) && (!"..".equals(ftpFile.getName())))
/*     */         {
/*     */ 
/*     */ 
/* 352 */           boolean isfolder = ftpFile.isDirectory();
/*     */           
/* 354 */           FtpFile newftpfile = new FtpFile(gbfrom88591(ftpFile.getName()), 
/* 355 */             isfolder, ftpFile.getSize(), ftpFile.getTimestamp());
/* 356 */           ftpfileLIst.add(newftpfile);
/*     */         }
/*     */       }
/* 359 */     } catch (IOException e) { throw new FtpIOException(e);
/*     */     }
/* 361 */     return ftpfileLIst;
/*     */   }
/*     */   
/*     */   /* Error */
...
/*     */     //   13: astore 5
/*     */     //   15: aload_0
/*     */     //   16: getfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   19: aload_0
/*     */     //   20: aload 5
/*     */     //   22: invokevirtual 334	java/io/File:getName	()Ljava/lang/String;
/*     */     //   25: invokespecial 53	org/sexftp/core/ftp/MyFtp:iso88591	(Ljava/lang/String;)Ljava/lang/String;
/*     */     //   28: invokevirtual 471	org/apache/commons/net/ftp/FTPClient:storeFileStream	(Ljava/lang/String;)Ljava/io/OutputStream;
/*     */     //   31: astore 4
/*     */     //   33: new 475	java/io/FileInputStream
/*     */     //   36: dup
/*     */     //   37: aload_1
/*     */     //   38: invokespecial 477	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
/*     */     //   41: astore_3
/*     */     //   42: aload 5
...
/*     */     //   84: dup
/*     */     //   85: ldc_w 359
/*     */     //   88: invokespecial 94	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
/*     */     //   91: lload 10
/*     */     //   93: invokevirtual 480	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
/*     */     //   96: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
/*     */     //   99: aload 12
/*     */     //   101: invokespecial 483	java/lang/RuntimeException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
/*     */     //   104: athrow
/*     */     //   105: lload 10
/*     */     //   107: iload 9
/*     */     //   109: i2l
...
/*     */     //   159: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
...
/*     */     //   183: dup
/*     */     //   184: aload 5
/*     */     //   186: invokespecial 298	org/sexftp/core/exceptions/FtpIOException:<init>	(Ljava/lang/Throwable;)V
/*     */     //   189: athrow
/*     */     //   190: astore 13
/*     */     //   192: aload_3
...
/*     */     //   208: pop
/*     */     //   209: aload_0
/*     */     //   210: getfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   213: invokevirtual 399	org/apache/commons/net/ftp/FTPClient:isConnected	()Z
/*     */     //   216: ifeq +26 -> 242
/*     */     //   219: aload_0
/*     */     //   220: getfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   223: invokevirtual 402	org/apache/commons/net/ftp/FTPClient:completePendingCommand	()Z
/*     */     //   226: pop
/*     */     //   227: goto +15 -> 242
/*     */     //   230: astore 14
...
/*     */     //   235: dup
/*     */     //   236: aload 14
/*     */     //   238: invokespecial 298	org/sexftp/core/exceptions/FtpIOException:<init>	(Ljava/lang/Throwable;)V
/*     */     //   241: athrow
/*     */     //   242: aload 13
/*     */     //   244: athrow
/*     */     //   245: aload_3
...
/*     */     //   261: pop
/*     */     //   262: aload_0
/*     */     //   263: getfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   266: invokevirtual 399	org/apache/commons/net/ftp/FTPClient:isConnected	()Z
/*     */     //   269: ifeq +26 -> 295
/*     */     //   272: aload_0
/*     */     //   273: getfield 25	org/sexftp/core/ftp/MyFtp:ftpclient	Lorg/apache/commons/net/ftp/FTPClient;
/*     */     //   276: invokevirtual 402	org/apache/commons/net/ftp/FTPClient:completePendingCommand	()Z
/*     */     //   279: pop
/*     */     //   280: goto +15 -> 295
/*     */     //   283: astore 14
...
/*     */     //   288: dup
/*     */     //   289: aload 14
/*     */     //   291: invokespecial 298	org/sexftp/core/exceptions/FtpIOException:<init>	(Ljava/lang/Throwable;)V
/*     */     //   294: athrow
/*     */     //   295: return
/*     */     // Line number table:
...
/*     */   {
/* 429 */     System.out.println("coy".substring(3));
/*     */   }
/*     */ }


/* Location:              C:\Users\jiang\Desktop\sexftp-2012.0.0\sexftp_2012.0.0.201202120942.jar!\org\sexftp\core\ftp\MyFtp.class
