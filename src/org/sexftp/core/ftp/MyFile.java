...
/*     */     try
/*     */     {
/*  52 */       List<FtpFile> list = new ArrayList();
/*  53 */       File[] listFiles = new File(this.curDir).listFiles();
/*  54 */       if (listFiles != null) {
/*     */         File[] arrayOfFile1;
/*  56 */         int j = (arrayOfFile1 = listFiles).length; for (int i = 0; i < j; i++) { File file = arrayOfFile1[i];
/*  57 */           Calendar instance = Calendar.getInstance();
/*  58 */           instance.setTime(new Date(file.lastModified()));
/*  59 */           long available = 0L;
/*  60 */           if (file.isFile())
/*     */           {
/*  62 */             available = file.length();
/*     */           }
/*     */           
/*  65 */           FtpFile ftpfile = new FtpFile(file.getName(), file.isDirectory(), available, instance);
/*  66 */           list.add(ftpfile);
/*     */         }
/*     */       }
/*  69 */       return list;
/*     */     } catch (Exception e) {
/*  71 */       throw new SRuntimeException(e);
/*     */     }
/*     */   }
/*     */   
/*     */   public void cd(String directory)
/*     */   {
/*  77 */     if (!new File(directory).exists())
/*     */     {
/*  79 */       throw new FtpNoSuchFileException("No Such Folder:" + directory);
/*     */     }
/*  81 */     this.curDir = directory;
/*     */   }
/*     */   
/*     */   /* Error */
...
/*     */     //   18: invokestatic 134	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
/*     */     //   21: invokespecial 122	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
/*     */     //   24: ldc -116
...
/*     */     //   44: dup
/*     */     //   45: aload_2
/*     */     //   46: invokespecial 144	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
/*     */     //   49: astore 4
/*     */     //   51: new 145	java/io/FileInputStream
/*     */     //   54: dup
/*     */     //   55: aload 6
/*     */     //   57: invokespecial 147	java/io/FileInputStream:<init>	(Ljava/io/File;)V
/*     */     //   60: astore 5
/*     */     //   62: aload 6
...
/*     */     //   176: dup
/*     */     //   177: aload 6
/*     */     //   179: invokespecial 179	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
/*     */     //   182: athrow
/*     */     //   183: astore 12
/*     */     //   185: aload 5
...
/*     */   {
/* 141 */     this.curDir = directory;
/* 142 */     if (!new File(this.curDir).exists())
/*     */     {
/* 144 */       new File(this.curDir).mkdirs();
/*     */     }
/*     */   }
/*     */   
/*     */   /* Error */
...
/*     */     //   27: invokestatic 134	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
/*     */     //   30: invokespecial 122	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
/*     */     //   33: ldc -116
...
/*     */     //   46: invokevirtual 127	java/lang/StringBuilder:toString	()Ljava/lang/String;
...
/*     */     //   70: invokestatic 134	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
...
/*     */     //   89: invokevirtual 127	java/lang/StringBuilder:toString	()Ljava/lang/String;
/*     */     //   92: invokespecial 144	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
/*     */     //   95: astore_3
/*     */     //   96: new 145	java/io/FileInputStream
/*     */     //   99: dup
/*     */     //   100: aload 5
/*     */     //   102: invokespecial 147	java/io/FileInputStream:<init>	(Ljava/io/File;)V
/*     */     //   105: astore 4
/*     */     //   107: aload 5
...
/*     */     //   175: dup
/*     */     //   176: ldc -52
/*     */     //   178: invokespecial 122	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
/*     */     //   181: aload 5
...
/*     */     //   219: dup
/*     */     //   220: aload 5
/*     */     //   222: invokespecial 179	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
/*     */     //   225: athrow
/*     */     //   226: astore 11
/*     */     //   228: aload 4
...
/* Location:              C:\Users\jiang\Desktop\sexftp-2012.0.0\sexftp_2012.0.0.201202120942.jar!\org\sexftp\core\ftp\MyFile.class
