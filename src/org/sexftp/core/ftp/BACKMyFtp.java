...
/*     */     try
/*     */     {
/*  47 */       this.ftpClient = new FtpClient();
/*  48 */       System.out.println(host + ":" + port + "@" + username + " logining ...");
/*  49 */       this.ftpClient.openServer(host, port);
/*     */       
/*  51 */       this.ftpClient.login(username, password);
/*     */       
/*  53 */       System.out.println("login success!");
/*     */ 
/*     */     }
...
/*     */   {
/*  71 */     if (this.ftpClient == null) return false;
/*  72 */     return this.ftpClient.serverIsOpen();
/*     */   }
/*     */   
...
/*     */     try
/*     */     {
/*  79 */       this.ftpClient.closeServer();
/*     */       
/*  81 */       System.out.println("disconnect success");
/*     */ 
/*     */ 
/*     */     }
/*     */     catch (IOException ex)
/*     */     {
/*     */ 
/*  88 */       System.out.println("not disconnect");
/*     */       
...
/*     */     //   0: aload_0
/*     */     //   1: aload_1
/*     */     //   2: invokevirtual 122	org/sexftp/core/ftp/BACKMyFtp:cd	(Ljava/lang/String;)V
...
/*     */     //   26: dup
/*     */     //   27: aload_0
/*     */     //   28: getfield 37	org/sexftp/core/ftp/BACKMyFtp:ftpClient	Lsun/net/ftp/FtpClient;
/*     */     //   31: invokevirtual 134	sun/net/ftp/FtpClient:list	()Lsun/net/TelnetInputStream;
/*     */     //   34: invokespecial 138	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
/*     */     //   37: invokespecial 141	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
/*     */     //   40: astore_3
/*     */     //   41: goto +12 -> 53
/*     */     //   44: aload_2
/*     */     //   45: aload 4
...
/*     */     //   52: pop
/*     */     //   53: aload_3
/*     */     //   54: invokevirtual 150	java/io/BufferedReader:readLine	()Ljava/lang/String;
/*     */     //   57: dup
/*     */     //   58: astore 4
/*     */     //   60: ifnonnull -16 -> 44
/*     */     //   63: goto +32 -> 95
...
/*     */     try
/*     */     {
/* 128 */       if (directory.length() != 0)
/*     */       {
/* 130 */         this.ftpClient.cd(directory);
/*     */       }
/* 132 */       this.ftpClient.binary();
/*     */     } catch (IOException e) {
/* 134 */       throw new RuntimeException("mkdirs " + directory + " fail!" + e, e);
/*     */     }
/*     */   }
/*     */   
/*     */   public void cdOrMakeIfNotExists(String directory) {
/*     */     try {
/* 140 */       if (directory.length() != 0)
/*     */       {
/* 142 */         this.ftpClient.cd(directory);
/*     */       }
/* 144 */       this.ftpClient.binary();
/*     */     } catch (IOException localIOException1) {
/*     */       try {
/* 147 */         mkdirs(directory);
/*     */       } catch (IOException e1) {
/* 149 */         throw new RuntimeException("mkdirs " + directory + " fail!" + e1, e1);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/* 156 */     String[] dirs = directory.split("/");
/* 157 */     if (directory.startsWith("/"))
/*     */     {
/* 159 */       this.ftpClient.cd("/"); }
/*     */     String[] arrayOfString1;
/* 161 */     int j = (arrayOfString1 = dirs).length; for (int i = 0; i < j; i++) { String dir = arrayOfString1[i];
/* 162 */       if (dir.length() > 0) {
/*     */         try
/*     */         {
/* 165 */           this.ftpClient.cd(dir);
/*     */         } catch (IOException localIOException) {
/* 167 */           this.ftpClient.sendServer("MKD " + dir + "\r\n");
/* 168 */           this.ftpClient.cd(dir);
/* 169 */           this.ftpClient.readServerResponse();
/*     */         }
/*     */       }
/*     */     }
/* 173 */     this.ftpClient.binary();
/*     */   }
/*     */   
/*     */   /* Error */
...
/*     */     //   25: dup
/*     */     //   26: aload_0
/*     */     //   27: getfield 37	org/sexftp/core/ftp/BACKMyFtp:ftpClient	Lsun/net/ftp/FtpClient;
/*     */     //   30: aload 5
/*     */     //   32: invokevirtual 222	java/io/File:getName	()Ljava/lang/String;
/*     */     //   35: invokevirtual 225	sun/net/ftp/FtpClient:nameList	(Ljava/lang/String;)Lsun/net/TelnetInputStream;
/*     */     //   38: invokespecial 229	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
/*     */     //   41: astore 7
/*     */     //   43: aload 7
/*     */     //   45: invokevirtual 230	java/io/DataInputStream:readLine	()Ljava/lang/String;
/*     */     //   48: dup
/*     */     //   49: astore 6
/*     */     //   51: ifnull +66 -> 117
...
/*     */     //   57: dup
/*     */     //   58: ldc -25
/*     */     //   60: invokespecial 53	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
/*     */     //   63: aload 6
...
/*     */     //   125: pop
/*     */     //   126: aload_0
/*     */     //   127: getfield 37	org/sexftp/core/ftp/BACKMyFtp:ftpClient	Lsun/net/ftp/FtpClient;
/*     */     //   130: aload 5
/*     */     //   132: invokevirtual 222	java/io/File:getName	()Ljava/lang/String;
/*     */     //   135: invokevirtual 236	sun/net/ftp/FtpClient:put	(Ljava/lang/String;)Lsun/net/TelnetOutputStream;
/*     */     //   138: astore_3
/*     */     //   139: new 240	java/io/FileInputStream
/*     */     //   142: dup
/*     */     //   143: aload 5
/*     */     //   145: invokespecial 242	java/io/FileInputStream:<init>	(Ljava/io/File;)V
/*     */     //   148: astore 4
/*     */     //   150: aload 4
...
/*     */     //   219: dup
/*     */     //   220: ldc_w 264
/*     */     //   223: invokespecial 53	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
/*     */     //   226: aload 5
...
/*     */     //   275: dup
/*     */     //   276: aload 5
/*     */     //   278: invokespecial 89	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
/*     */     //   281: athrow
/*     */     //   282: astore 12
/*     */     //   284: aload 4
...
/*     */       {
/*     */ 
/* 269 */         TelnetOutputStream os = this.ftpClient.put(fileList[i]);
/*     */         
/* 271 */         File file_in = new File("e://12//" + 
/* 272 */           fileList[i]);
/*     */         
/* 274 */         FileInputStream is = new FileInputStream(file_in);
/*     */         
/* 276 */         byte[] bytes = new byte['Ѐ'];
/*     */         
/*     */         int c;
/*     */         
/* 280 */         while ((c = is.read(bytes)) != -1) {
/*     */           int c;
/* 282 */           os.write(bytes, 0, c);
/*     */         }
/*     */         
/*     */ 
/* 286 */         System.out.println("upload success");
/*     */         
/* 288 */         is.close();
/*     */         
/* 290 */         os.close();
...
/*     */       catch (IOException ex)
/*     */       {
/* 294 */         System.out.println("not upload");
/*     */         
/* 296 */         System.out.println(ex);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/* Location:              C:\Users\jiang\Desktop\sexftp-2012.0.0\sexftp_2012.0.0.201202120942.jar!\org\sexftp\core\ftp\BACKMyFtp.class
