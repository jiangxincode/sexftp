...
public class ByteUtils {
	...
	public static void writeByte2Stream(byte[] data, java.io.OutputStream os) {
		...
		// 14: ifnull +15 -> 29
		// 17: aload_2
		// 18: invokevirtual 116 java/io/IOException:toString
		// ()Ljava/lang/String;
		// 21: ldc 119
		...
		// 32: dup
		// 33: aload_2
		// 34: invokespecial 127 java/lang/RuntimeException:<init>
		...
		// 53: ifnull +14 -> 67
		// 56: aload 4
		// 58: invokevirtual 116 java/io/IOException:toString
		// ()Ljava/lang/String;
		// 61: ldc 119
		...
		// 70: dup
		// 71: aload 4
		// 73: invokespecial 127 java/lang/RuntimeException:<init>
		// (Ljava/lang/Throwable;)V
		// 76: athrow
		// 77: astore_3
		// 78: aload_1
		...
		// 93: ifnull +14 -> 107
		// 96: aload 4
		// 98: invokevirtual 116 java/io/IOException:toString
		// ()Ljava/lang/String;
		// 101: ldc 119
		...
		// 110: dup
		// 111: aload 4
		// 113: invokespecial 127 java/lang/RuntimeException:<init>
		// (Ljava/lang/Throwable;)V
		// 116: athrow
		// 117: aload_3
		// 118: athrow
		...
		// 134: ifnull +14 -> 148
		// 137: aload 4
		// 139: invokevirtual 116 java/io/IOException:toString
		// ()Ljava/lang/String;
		// 142: ldc 119
		...
		// 151: dup
		// 152: aload 4
		// 154: invokespecial 127 java/lang/RuntimeException:<init>
		// (Ljava/lang/Throwable;)V
		// 157: athrow
		// 158: return
		// Line number table:
