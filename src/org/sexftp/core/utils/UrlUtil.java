...
public class UrlUtil {
	...
	public static byte[] requestUrlData(String url, byte[] requestdata) {
		...
		// 12: invokevirtual 21 java/net/URL:openConnection
		...
		// 45: aload 5
		// 47: ldc 42
		// 49: invokevirtual 44 java/net/HttpURLConnection:setRequestMethod
		// (Ljava/lang/String;)V
		// 52: aload 5
		// 54: ldc 47
		// 56: ldc 49
		// 58: invokevirtual 51 java/net/HttpURLConnection:setRequestProperty
		...
		// 72: ifne +22 -> 94
		// 75: aload 5
		// 77: invokevirtual 63 java/net/HttpURLConnection:getOutputStream
		...
		// 99: aload 5
		// 101: invokevirtual 82 java/net/HttpURLConnection:getInputStream
		...
		// 169: dup
		// 170: aload 5
		// 172: invokespecial 105
		// org/sexftp/core/exceptions/SFConnectionException:<init>
		...
		// 181: dup
		// 182: aload 5
		// 184: invokespecial 110 java/lang/RuntimeException:<init>
		// (Ljava/lang/Throwable;)V
		// 187: athrow
		// 188: astore 9
		// 190: aload_2
