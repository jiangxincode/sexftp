...
public class FileUtil {
	...
	public static void writeByte2File(String fielname, byte[] data) {
		...
		// 20: dup
		// 21: aload_0
		// 22: invokespecial 93 java/io/FileOutputStream:<init>
		// (Ljava/lang/String;)V
		// 25: astore_2
		// 26: aload_2
		// 27: aload_1
		...
		// 42: dup
		// 43: aload_3
		// 44: invokespecial 65 java/lang/RuntimeException:<init>
	...
	public static void copyFile(String srcPath, String desPath) {
		...
		// 10: dup
		// 11: aload_0
		// 12: invokespecial 46 java/io/FileInputStream:<init>
		// (Ljava/lang/String;)V
		// 15: astore_2
		// 16: new 91 java/io/FileOutputStream
		// 19: dup
		// 20: aload_1
		// 21: invokespecial 93 java/io/FileOutputStream:<init>
		// (Ljava/lang/String;)V
		// 24: astore_3
		// 25: sipush 8192
		...
		// 59: dup
		// 60: ldc -126
		// 62: invokespecial 132 java/lang/StringBuilder:<init>
		// (Ljava/lang/String;)V
		// 65: iload 4
		// 67: invokevirtual 133 java/lang/StringBuilder:append
		// (I)Ljava/lang/StringBuilder;
		// 70: ldc -119
		// 72: invokevirtual 139 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 75: aload 7
		// 77: invokevirtual 142 java/lang/Exception:getMessage
		// ()Ljava/lang/String;
		// 80: invokevirtual 139 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 83: invokevirtual 146 java/lang/StringBuilder:toString
		// ()Ljava/lang/String;
		// 86: aload 7
		// 88: invokespecial 149 java/lang/RuntimeException:<init>
	...
	public static Set<String> unionUpFilePath(Set<String> pathList) {
		...
		int j = 0;
		int i = 0;
		for (Iterator localIterator = pathList.iterator(); localIterator.hasNext() &&

		i < j;) {
			String path = (String) localIterator.next();

			File file = new File(path);
			String addPath = file.isDirectory() ? file.getAbsolutePath() : file.getParent();
			newPathList.add(addPath);
			String[] arrayOfString;
			j = (arrayOfString = (String[]) newPathList.toArray(new String[0])).length;
			i = 0;
			String oldPath = arrayOfString[i];
