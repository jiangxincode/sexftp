...
public final class TFTPExample
{
  ...
  public static final void main(String[] args)
  {
    ...
    //   16: aload 5
    //   18: ldc 21
    //   20: invokevirtual 23	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   23: ifeq +93 -> 116
    //   26: aload 5
    //   28: ldc 29
    ...
    //   89: ldc 47
    //   91: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    ...
    //   170: dup
    //   171: invokespecial 66	org/apache/commons/net/tftp/TFTPClient:<init>	()V
    //   174: astore 9
    //   176: aload 9
    //   178: ldc 67
    //   180: invokevirtual 68	org/apache/commons/net/tftp/TFTPClient:setDefaultTimeout	(I)V
    //   183: aload 9
    ...
    //   196: ldc 74
    //   198: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   201: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   204: aload 10
    //   206: invokevirtual 76	java/net/SocketException:getMessage	()Ljava/lang/String;
    //   209: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   212: iconst_1
    ...
    //   250: dup
    //   251: ldc 92
    //   253: invokespecial 94	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   256: aload 7
    //   258: invokevirtual 95	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   261: ldc 99
    ...
    //   279: dup
    //   280: aload 11
    //   282: invokespecial 106	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   285: astore 10
    //   287: goto +33 -> 320
    //   290: astore 12
    //   292: aload 9
    //   294: invokevirtual 109	org/apache/commons/net/tftp/TFTPClient:close	()V
    //   297: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   300: ldc 112
    //   302: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   305: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   308: aload 12
    //   310: invokevirtual 114	java/io/IOException:getMessage	()Ljava/lang/String;
    //   313: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   316: iconst_1
    ...
    //   325: aload 10
    //   327: aload 6
    //   329: invokevirtual 117	org/apache/commons/net/tftp/TFTPClient:receiveFile	(Ljava/lang/String;ILjava/io/OutputStream;Ljava/lang/String;)I
    //   332: pop
    //   333: goto +193 -> 526
    //   336: astore 12
    //   338: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   341: ldc 121
    //   343: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   346: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   349: aload 12
    //   351: invokevirtual 123	java/net/UnknownHostException:getMessage	()Ljava/lang/String;
    //   354: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   357: iconst_1
    //   358: invokestatic 58	java/lang/System:exit	(I)V
    //   361: aload 9
    //   363: invokevirtual 109	org/apache/commons/net/tftp/TFTPClient:close	()V
    //   366: aload 10
    //   368: ifnull +8 -> 376
    //   371: aload 10
    ...
    //   388: ldc 127
    //   390: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   393: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   396: aload 14
    //   398: invokevirtual 114	java/io/IOException:getMessage	()Ljava/lang/String;
    //   401: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   404: goto +165 -> 569
    //   407: astore 12
    //   409: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   412: ldc -127
    //   414: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   417: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   420: aload 12
    //   422: invokevirtual 114	java/io/IOException:getMessage	()Ljava/lang/String;
    //   425: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   428: iconst_1
    //   429: invokestatic 58	java/lang/System:exit	(I)V
    //   432: aload 9
    //   434: invokevirtual 109	org/apache/commons/net/tftp/TFTPClient:close	()V
    //   437: aload 10
    //   439: ifnull +8 -> 447
    //   442: aload 10
    ...
    //   459: ldc 127
    //   461: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   464: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   467: aload 14
    //   469: invokevirtual 114	java/io/IOException:getMessage	()Ljava/lang/String;
    //   472: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   475: goto +94 -> 569
    //   478: astore 13
    //   480: aload 9
    //   482: invokevirtual 109	org/apache/commons/net/tftp/TFTPClient:close	()V
    //   485: aload 10
    //   487: ifnull +8 -> 495
    //   490: aload 10
    ...
    //   507: ldc 127
    //   509: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   512: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   515: aload 14
    //   517: invokevirtual 114	java/io/IOException:getMessage	()Ljava/lang/String;
    //   520: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   523: aload 13
    //   525: athrow
    //   526: aload 9
    //   528: invokevirtual 109	org/apache/commons/net/tftp/TFTPClient:close	()V
    //   531: aload 10
    //   533: ifnull +8 -> 541
    //   536: aload 10
    ...
    //   553: ldc 127
    //   555: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   558: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   561: aload 14
    //   563: invokevirtual 114	java/io/IOException:getMessage	()Ljava/lang/String;
    //   566: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   569: iload_2
    //   570: ifne +313 -> 883
    //   573: iconst_1
    ...
    //   586: dup
    //   587: aload 7
    //   589: invokespecial 133	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   592: astore 10
    //   594: goto +33 -> 627
    //   597: astore 11
    //   599: aload 9
    //   601: invokevirtual 109	org/apache/commons/net/tftp/TFTPClient:close	()V
    //   604: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   607: ldc -122
    //   609: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   612: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   615: aload 11
    //   617: invokevirtual 114	java/io/IOException:getMessage	()Ljava/lang/String;
    //   620: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   623: iconst_1
    ...
    //   632: aload 10
    //   634: aload 6
    //   636: invokevirtual 136	org/apache/commons/net/tftp/TFTPClient:sendFile	(Ljava/lang/String;ILjava/io/InputStream;Ljava/lang/String;)V
    //   639: goto +193 -> 832
    //   642: astore 11
    //   644: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   647: ldc 121
    //   649: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   652: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   655: aload 11
    //   657: invokevirtual 123	java/net/UnknownHostException:getMessage	()Ljava/lang/String;
    //   660: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   663: iconst_1
    //   664: invokestatic 58	java/lang/System:exit	(I)V
    //   667: aload 9
    //   669: invokevirtual 109	org/apache/commons/net/tftp/TFTPClient:close	()V
    //   672: aload 10
    //   674: ifnull +8 -> 682
    //   677: aload 10
    ...
    //   694: ldc 127
    //   696: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   699: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   702: aload 13
    //   704: invokevirtual 114	java/io/IOException:getMessage	()Ljava/lang/String;
    //   707: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   710: goto +165 -> 875
    //   713: astore 11
    //   715: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   718: ldc -115
    //   720: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   723: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   726: aload 11
    //   728: invokevirtual 114	java/io/IOException:getMessage	()Ljava/lang/String;
    //   731: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   734: iconst_1
    //   735: invokestatic 58	java/lang/System:exit	(I)V
    //   738: aload 9
    //   740: invokevirtual 109	org/apache/commons/net/tftp/TFTPClient:close	()V
    //   743: aload 10
    //   745: ifnull +8 -> 753
    //   748: aload 10
    ...
    //   765: ldc 127
    //   767: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   770: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   773: aload 13
    //   775: invokevirtual 114	java/io/IOException:getMessage	()Ljava/lang/String;
    //   778: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   781: goto +94 -> 875
    //   784: astore 12
    //   786: aload 9
    //   788: invokevirtual 109	org/apache/commons/net/tftp/TFTPClient:close	()V
    //   791: aload 10
    //   793: ifnull +8 -> 801
    //   796: aload 10
    ...
    //   813: ldc 127
    //   815: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   818: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   821: aload 13
    //   823: invokevirtual 114	java/io/IOException:getMessage	()Ljava/lang/String;
    //   826: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   829: aload 12
    //   831: athrow
    //   832: aload 9
    //   834: invokevirtual 109	org/apache/commons/net/tftp/TFTPClient:close	()V
    //   837: aload 10
    //   839: ifnull +8 -> 847
    //   842: aload 10
    ...
    //   859: ldc 127
    //   861: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   864: getstatic 41	java/lang/System:err	Ljava/io/PrintStream;
    //   867: aload 13
    //   869: invokevirtual 114	java/io/IOException:getMessage	()Ljava/lang/String;
    //   872: invokevirtual 49	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   875: iload_2
    //   876: ifne +7 -> 883
    //   879: iconst_1
...
/* Location:              C:\Users\jiang\Desktop\sexftp-2012.0.0\sexftp_2012.0.0.201202120942.jar!\examples\ftp\TFTPExample.class
