...
public final class FTPClientExample {
	...
	public static final void main(String[] args) {
		...
		// 447: ldc 8
		// 449: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 452: iconst_1
		...
		// 468: aload 23
		// 470: ldc 91
		// 472: invokevirtual 93 java/lang/String:split
		...
		// 587: dup
		// 588: iconst_1
		// 589: invokespecial 104 org/apache/commons/net/ftp/FTPSClient:<init>
		// (Z)V
		// 592: astore 31
		// 594: goto +76 -> 670
		// 597: aload 18
		...
		// 610: dup
		// 611: iconst_0
		// 612: invokespecial 104 org/apache/commons/net/ftp/FTPSClient:<init>
		// (Z)V
		// 615: astore 31
		// 617: goto +53 -> 670
		// 620: aload 18
		// 622: ldc 109
		// 624: invokevirtual 93 java/lang/String:split
		// (Ljava/lang/String;)[Ljava/lang/String;
		// 627: astore 32
		// 629: aload 32
		// 631: arraylength
		...
		// 639: dup
		// 640: aload 18
		// 642: invokespecial 111 org/apache/commons/net/ftp/FTPSClient:<init>
		// (Ljava/lang/String;)V
		// 645: astore 31
		// 647: goto +23 -> 670
		...
		// 660: iconst_1
		// 661: aaload
		// 662: invokestatic 113 java/lang/Boolean:parseBoolean
		// (Ljava/lang/String;)Z
		// 665: invokespecial 119 org/apache/commons/net/ftp/FTPSClient:<init>
		...
		// 681: ifeq +14 -> 695
		// 684: aload 31
		// 686: invokestatic 124
		// org/apache/commons/net/util/TrustManagerUtils:getAcceptAllTrustManager
		// ()Ljavax/net/ssl/X509TrustManager;
		// 689: invokevirtual 130
		...
		// org/apache/commons/net/util/TrustManagerUtils:getValidateServerCertificateTrustManager
		// ()Ljavax/net/ssl/X509TrustManager;
		// 710: invokevirtual 130
		// org/apache/commons/net/ftp/FTPSClient:setTrustManager
		// (Ljavax/net/ssl/TrustManager;)V
		// 713: goto +19 -> 732
		// 716: ldc -117
		...
		// 726: aload 31
		// 728: aconst_null
		// 729: invokevirtual 130
		// org/apache/commons/net/ftp/FTPSClient:setTrustManager
		// (Ljavax/net/ssl/TrustManager;)V
		// 732: iload 10
		// 734: ifeq +11 -> 745
		// 737: aload 30
		// 739: invokestatic 141 examples/ftp/FTPClientExample:createListener
		// ()Lorg/apache/commons/net/io/CopyStreamListener;
		// 742: invokevirtual 145
		// org/apache/commons/net/ftp/FTPClient:setCopyStreamListener
		// (Lorg/apache/commons/net/io/CopyStreamListener;)V
		// 745: lload 14
		// 747: lconst_0
		// 748: lcmp
		// 749: iflt +10 -> 759
		// 752: aload 30
		// 754: lload 14
		// 756: invokevirtual 149
		// org/apache/commons/net/ftp/FTPClient:setControlKeepAliveTimeout (J)V
		// 759: iload 16
		// 761: iflt +10 -> 771
		// 764: aload 30
		// 766: iload 16
		// 768: invokevirtual 153
		// org/apache/commons/net/ftp/FTPClient:setControlKeepAliveReplyTimeout
		// (I)V
		// 771: aload 30
		// 773: iload 6
		// 775: invokevirtual 156
		// org/apache/commons/net/ftp/FTPClient:setListHiddenFiles (Z)V
		// 778: aload 30
		...
		// 791: invokespecial 166 java/io/PrintWriter:<init>
		// (Ljava/io/OutputStream;)V
		// 794: iconst_1
		// 795: invokespecial 169
		// org/apache/commons/net/PrintCommandListener:<init>
		// (Ljava/io/PrintWriter;Z)V
		// 798: invokevirtual 172
		// org/apache/commons/net/ftp/FTPClient:addProtocolCommandListener
		// (Lorg/apache/commons/net/ProtocolCommandListener;)V
		// 801: iload 24
		// 803: ifle +15 -> 818
		// 806: aload 30
		// 808: aload 23
		// 810: iload 24
		// 812: invokevirtual 176 org/apache/commons/net/ftp/FTPClient:connect
		// (Ljava/lang/String;I)V
		// 815: goto +10 -> 825
		// 818: aload 30
		// 820: aload 23
		// 822: invokevirtual 180 org/apache/commons/net/ftp/FTPClient:connect
		// (Ljava/lang/String;)V
		// 825: getstatic 163 java/lang/System:out Ljava/io/PrintStream;
		// 828: new 182 java/lang/StringBuilder
		// 831: dup
		// 832: ldc -72
		// 834: invokespecial 186 java/lang/StringBuilder:<init>
		// (Ljava/lang/String;)V
		// 837: aload 23
		// 839: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 842: ldc -65
		// 844: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 847: aload 30
		// 849: invokevirtual 193
		// org/apache/commons/net/ftp/FTPClient:getRemotePort ()I
		// 852: invokevirtual 197 java/lang/StringBuilder:append
		// (I)Ljava/lang/StringBuilder;
		// 855: invokevirtual 200 java/lang/StringBuilder:toString
		// ()Ljava/lang/String;
		// 858: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 861: aload 30
		// 863: invokevirtual 204
		// org/apache/commons/net/ftp/FTPClient:getReplyCode ()I
		// 866: istore 31
		// 868: iload 31
		// 870: invokestatic 207
		// org/apache/commons/net/ftp/FTPReply:isPositiveCompletion (I)Z
		// 873: ifne +59 -> 932
		// 876: aload 30
		// 878: invokevirtual 213
		// org/apache/commons/net/ftp/FTPClient:disconnect ()V
		// 881: getstatic 75 java/lang/System:err Ljava/io/PrintStream;
		// 884: ldc -40
		// 886: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 889: iconst_1
		...
		// 934: aload 26
		// 936: aload 27
		// 938: invokevirtual 229 org/apache/commons/net/ftp/FTPClient:login
		// (Ljava/lang/String;Ljava/lang/String;)Z
		// 941: ifne +31 -> 972
		// 944: aload 30
		// 946: invokevirtual 233 org/apache/commons/net/ftp/FTPClient:logout
		// ()Z
		// 949: pop
		// 950: iconst_1
		// 951: istore_3
		// 952: aload 30
		// 954: invokevirtual 218
		// org/apache/commons/net/ftp/FTPClient:isConnected ()Z
		// 957: ifeq +867 -> 1824
		// 960: aload 30
		// 962: invokevirtual 213
		// org/apache/commons/net/ftp/FTPClient:disconnect ()V
		// 965: goto +859 -> 1824
		// 968: pop
		// 969: goto +855 -> 1824
		...
		// 978: dup
		// 979: ldc -20
		// 981: invokespecial 186 java/lang/StringBuilder:<init>
		// (Ljava/lang/String;)V
		// 984: aload 30
		// 986: invokevirtual 238
		// org/apache/commons/net/ftp/FTPClient:getSystemType
		// ()Ljava/lang/String;
		// 989: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 992: invokevirtual 200 java/lang/StringBuilder:toString
		// ()Ljava/lang/String;
		// 995: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 998: iload_2
		// 999: ifeq +10 -> 1009
		// 1002: aload 30
		// 1004: iconst_2
		// 1005: invokevirtual 241
		// org/apache/commons/net/ftp/FTPClient:setFileType (I)Z
		// 1008: pop
		// 1009: iload 7
		// 1011: ifeq +11 -> 1022
		// 1014: aload 30
		// 1016: invokevirtual 244
		// org/apache/commons/net/ftp/FTPClient:enterLocalActiveMode ()V
		// 1019: goto +8 -> 1027
		// 1022: aload 30
		// 1024: invokevirtual 247
		// org/apache/commons/net/ftp/FTPClient:enterLocalPassiveMode ()V
		// 1027: aload 30
		// 1029: iload 8
		// 1031: invokevirtual 250
		// org/apache/commons/net/ftp/FTPClient:setUseEPSVwithIPv4 (Z)V
		// 1034: iload_1
		// 1035: ifeq +32 -> 1067
		// 1038: new 253 java/io/FileInputStream
		// 1041: dup
		// 1042: aload 29
		// 1044: invokespecial 255 java/io/FileInputStream:<init>
		// (Ljava/lang/String;)V
		// 1047: astore 31
		// 1049: aload 30
		// 1051: aload 28
		// 1053: aload 31
		// 1055: invokevirtual 256
		// org/apache/commons/net/ftp/FTPClient:storeFile
		...
		// 1080: dup
		// 1081: invokespecial 267
		// org/apache/commons/net/ftp/FTPClientConfig:<init> ()V
		// 1084: astore 31
		// 1086: aload 31
		// 1088: iconst_1
		...
		// 1092: aload 30
		// 1094: aload 31
		// 1096: invokevirtual 271
		// org/apache/commons/net/ftp/FTPClient:configure
		// (Lorg/apache/commons/net/ftp/FTPClientConfig;)V
		// 1099: aload 30
		// 1101: aload 28
		// 1103: invokevirtual 275
		// org/apache/commons/net/ftp/FTPClient:listFiles
		// (Ljava/lang/String;)[Lorg/apache/commons/net/ftp/FTPFile;
		// 1106: dup
		// 1107: astore 34
		// 1109: arraylength
		// 1110: istore 33
		...
		// 1128: aload 31
		// 1130: invokevirtual 279
		// org/apache/commons/net/ftp/FTPFile:getRawListing ()Ljava/lang/String;
		// 1133: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1136: getstatic 163 java/lang/System:out Ljava/io/PrintStream;
		// 1139: aload 31
		// 1141: invokevirtual 284
		// org/apache/commons/net/ftp/FTPFile:toFormattedString
		// ()Ljava/lang/String;
		// 1144: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1147: iinc 32 1
		// 1150: iload 32
		// 1152: iload 33
		...
		// 1165: aload 30
		// 1167: aload 28
		// 1169: invokevirtual 287 org/apache/commons/net/ftp/FTPClient:mlistDir
		// (Ljava/lang/String;)[Lorg/apache/commons/net/ftp/FTPFile;
		// 1172: dup
		// 1173: astore 34
		// 1175: arraylength
		...
		// 1194: aload 31
		// 1196: invokevirtual 279
		// org/apache/commons/net/ftp/FTPFile:getRawListing ()Ljava/lang/String;
		// 1199: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1202: getstatic 163 java/lang/System:out Ljava/io/PrintStream;
		// 1205: aload 31
		// 1207: invokevirtual 284
		// org/apache/commons/net/ftp/FTPFile:toFormattedString
		// ()Ljava/lang/String;
		// 1210: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1213: iinc 32 1
		// 1216: iload 32
		// 1218: iload 33
		...
		// 1231: aload 30
		// 1233: aload 28
		// 1235: invokevirtual 290
		// org/apache/commons/net/ftp/FTPClient:mlistFile
		// (Ljava/lang/String;)Lorg/apache/commons/net/ftp/FTPFile;
		// 1238: astore 31
		// 1240: aload 31
		...
		// 1248: aload 31
		// 1250: invokevirtual 284
		// org/apache/commons/net/ftp/FTPFile:toFormattedString
		// ()Ljava/lang/String;
		// 1253: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1256: goto +447 -> 1703
		// 1259: iload 5
		// 1261: ifeq +50 -> 1311
		...
		// 1293: aload 31
		// 1295: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1298: iinc 32 1
		// 1301: iload 32
		// 1303: iload 33
		...
		// 1321: aload 30
		// 1323: aload 28
		// 1325: invokevirtual 297
		// org/apache/commons/net/ftp/FTPClient:hasFeature (Ljava/lang/String;)Z
		// 1328: ifeq +30 -> 1358
		// 1331: getstatic 163 java/lang/System:out Ljava/io/PrintStream;
		// 1334: new 182 java/lang/StringBuilder
		// 1337: dup
		// 1338: ldc_w 300
		// 1341: invokespecial 186 java/lang/StringBuilder:<init>
		// (Ljava/lang/String;)V
		// 1344: aload 28
		// 1346: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 1349: invokevirtual 200 java/lang/StringBuilder:toString
		// ()Ljava/lang/String;
		// 1352: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1355: goto +74 -> 1429
		// 1358: aload 30
		// 1360: invokevirtual 204
		// org/apache/commons/net/ftp/FTPClient:getReplyCode ()I
		// 1363: invokestatic 207
		// org/apache/commons/net/ftp/FTPReply:isPositiveCompletion (I)Z
		// 1366: ifeq +36 -> 1402
		...
		// 1375: dup
		// 1376: ldc_w 302
		// 1379: invokespecial 186 java/lang/StringBuilder:<init>
		// (Ljava/lang/String;)V
		// 1382: aload 28
		// 1384: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 1387: ldc_w 304
		// 1390: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 1393: invokevirtual 200 java/lang/StringBuilder:toString
		// ()Ljava/lang/String;
		// 1396: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1399: goto +30 -> 1429
		...
		// 1408: dup
		// 1409: ldc_w 306
		// 1412: invokespecial 186 java/lang/StringBuilder:<init>
		// (Ljava/lang/String;)V
		// 1415: aload 30
		// 1417: invokevirtual 308
		// org/apache/commons/net/ftp/FTPClient:getReplyString
		// ()Ljava/lang/String;
		// 1420: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 1423: invokevirtual 200 java/lang/StringBuilder:toString
		// ()Ljava/lang/String;
		// 1426: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1429: aload 30
		// 1431: aload 28
		// 1433: invokevirtual 311
		// org/apache/commons/net/ftp/FTPClient:featureValues
		// (Ljava/lang/String;)[Ljava/lang/String;
		// 1436: astore 31
		// 1438: aload 31
		// 1440: ifnull +78 -> 1518
		...
		// 1470: dup
		// 1471: ldc_w 302
		// 1474: invokespecial 186 java/lang/StringBuilder:<init>
		// (Ljava/lang/String;)V
		// 1477: aload 28
		// 1479: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 1482: ldc_w 314
		// 1485: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 1488: aload 32
		// 1490: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 1493: ldc_w 316
		// 1496: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 1499: invokevirtual 200 java/lang/StringBuilder:toString
		// ()Ljava/lang/String;
		// 1502: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1505: iinc 33 1
		// 1508: iload 33
		// 1510: iload 34
		...
		// 1515: goto +188 -> 1703
		// 1518: aload 30
		// 1520: invokevirtual 204
		// org/apache/commons/net/ftp/FTPClient:getReplyCode ()I
		// 1523: invokestatic 207
		// org/apache/commons/net/ftp/FTPReply:isPositiveCompletion (I)Z
		// 1526: ifeq +36 -> 1562
		...
		// 1535: dup
		// 1536: ldc_w 302
		// 1539: invokespecial 186 java/lang/StringBuilder:<init>
		// (Ljava/lang/String;)V
		// 1542: aload 28
		// 1544: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 1547: ldc_w 318
		// 1550: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 1553: invokevirtual 200 java/lang/StringBuilder:toString
		// ()Ljava/lang/String;
		// 1556: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1559: goto +144 -> 1703
		...
		// 1568: dup
		// 1569: ldc_w 306
		// 1572: invokespecial 186 java/lang/StringBuilder:<init>
		// (Ljava/lang/String;)V
		// 1575: aload 30
		// 1577: invokevirtual 308
		// org/apache/commons/net/ftp/FTPClient:getReplyString
		// ()Ljava/lang/String;
		// 1580: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 1583: invokevirtual 200 java/lang/StringBuilder:toString
		// ()Ljava/lang/String;
		// 1586: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1589: goto +114 -> 1703
		// 1592: aload 30
		// 1594: invokevirtual 320 org/apache/commons/net/ftp/FTPClient:features
		// ()Z
		// 1597: ifne +106 -> 1703
		...
		// 1606: dup
		// 1607: ldc_w 323
		// 1610: invokespecial 186 java/lang/StringBuilder:<init>
		// (Ljava/lang/String;)V
		// 1613: aload 30
		// 1615: invokevirtual 308
		// org/apache/commons/net/ftp/FTPClient:getReplyString
		// ()Ljava/lang/String;
		// 1618: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 1621: invokevirtual 200 java/lang/StringBuilder:toString
		// ()Ljava/lang/String;
		// 1624: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1627: goto +76 -> 1703
		// 1630: aload 19
		// 1632: ifnull +45 -> 1677
		...
		// 1637: aload 19
		// 1639: aload 28
		// 1641: invokevirtual 325
		// org/apache/commons/net/ftp/FTPClient:doCommand
		// (Ljava/lang/String;Ljava/lang/String;)Z
		// 1644: ifne +59 -> 1703
		...
		// 1653: dup
		// 1654: ldc_w 323
		// 1657: invokespecial 186 java/lang/StringBuilder:<init>
		// (Ljava/lang/String;)V
		// 1660: aload 30
		// 1662: invokevirtual 308
		// org/apache/commons/net/ftp/FTPClient:getReplyString
		// ()Ljava/lang/String;
		// 1665: invokevirtual 187 java/lang/StringBuilder:append
		// (Ljava/lang/String;)Ljava/lang/StringBuilder;
		// 1668: invokevirtual 200 java/lang/StringBuilder:toString
		// ()Ljava/lang/String;
		// 1671: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1674: goto +29 -> 1703
		// 1677: new 328 java/io/FileOutputStream
		// 1680: dup
		// 1681: aload 29
		// 1683: invokespecial 330 java/io/FileOutputStream:<init>
		// (Ljava/lang/String;)V
		// 1686: astore 31
		// 1688: aload 30
		// 1690: aload 28
		// 1692: aload 31
		// 1694: invokevirtual 331
		// org/apache/commons/net/ftp/FTPClient:retrieveFile
		// (Ljava/lang/String;Ljava/io/OutputStream;)Z
		// 1697: pop
		// 1698: aload 31
		...
		// 1708: pop
		// 1709: aload 30
		// 1711: invokevirtual 233 org/apache/commons/net/ftp/FTPClient:logout
		// ()Z
		// 1714: pop
		// 1715: goto +92 -> 1807
		// 1718: astore 31
		...
		// 1725: ldc_w 341
		// 1728: invokevirtual 81 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 1731: aload 31
		// 1733: invokevirtual 343
		// org/apache/commons/net/ftp/FTPConnectionClosedException:printStackTrace
		// ()V
		// 1736: aload 30
		// 1738: invokevirtual 218
		// org/apache/commons/net/ftp/FTPClient:isConnected ()Z
		// 1741: ifeq +83 -> 1824
		// 1744: aload 30
		// 1746: invokevirtual 213
		// org/apache/commons/net/ftp/FTPClient:disconnect ()V
		// 1749: goto +75 -> 1824
		// 1752: pop
		// 1753: goto +71 -> 1824
		...
		// 1765: aload 30
		// 1767: invokevirtual 218
		// org/apache/commons/net/ftp/FTPClient:isConnected ()Z
		// 1770: ifeq +54 -> 1824
		// 1773: aload 30
		// 1775: invokevirtual 213
		// org/apache/commons/net/ftp/FTPClient:disconnect ()V
		// 1778: goto +46 -> 1824
		// 1781: pop
		// 1782: goto +42 -> 1824
		// 1785: astore 36
		// 1787: aload 30
		// 1789: invokevirtual 218
		// org/apache/commons/net/ftp/FTPClient:isConnected ()Z
		// 1792: ifeq +12 -> 1804
		// 1795: aload 30
		// 1797: invokevirtual 213
		// org/apache/commons/net/ftp/FTPClient:disconnect ()V
		// 1800: goto +4 -> 1804
		// 1803: pop
		// 1804: aload 36
		// 1806: athrow
		// 1807: aload 30
		// 1809: invokevirtual 218
		// org/apache/commons/net/ftp/FTPClient:isConnected ()Z
		// 1812: ifeq +12 -> 1824
		// 1815: aload 30
		// 1817: invokevirtual 213
		// org/apache/commons/net/ftp/FTPClient:disconnect ()V
		// 1820: goto +4 -> 1824
		// 1823: pop
		// 1824: iload_3
