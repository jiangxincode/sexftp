...
public final class ListNewsgroups {
	...
	public static final void main(String[] args) {
		...
		// 9: ldc 22
		// 11: invokevirtual 24 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 14: return
		// 15: new 30 org/apache/commons/net/nntp/NNTPClient
		// 18: dup
		// 19: invokespecial 32 org/apache/commons/net/nntp/NNTPClient:<init>
		// ()V
		// 22: astore_1
		// 23: aload_0
		// 24: arraylength
		...
		// 40: iconst_0
		// 41: aaload
		// 42: invokevirtual 35 org/apache/commons/net/nntp/NNTPClient:connect
		// (Ljava/lang/String;)V
		// 45: iconst_0
		// 46: istore_3
		// 47: aload_1
		...
		// 80: aload 4
		// 82: invokevirtual 24 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 85: aload 5
		...
		// ()Ljava/lang/String;
		// 152: invokevirtual 24 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 155: aload 5
		...
		// org/apache/commons/net/nntp/NNTPClient:isConnected ()Z
		// 184: ifeq +103 -> 287
		// 187: aload_1
		// 188: invokevirtual 83
		// org/apache/commons/net/nntp/NNTPClient:disconnect ()V
		// 191: goto +96 -> 287
		// 194: astore 7
		// 196: getstatic 16 java/lang/System:err Ljava/io/PrintStream;
		// 199: ldc 86
		// 201: invokevirtual 24 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 204: aload 7
		...
		// 237: ldc 86
		// 239: invokevirtual 24 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 242: aload 7
		...
		// 273: ldc 86
		// 275: invokevirtual 24 java/io/PrintStream:println
		// (Ljava/lang/String;)V
		// 278: aload 7
