...
public class Install {
	...
	public static void main(String[] args) throws Exception {
		...
		for (;;) {
			...
			String sexftpstr = ByteUtils.getHexString("sexftp,2012.".getBytes("utf-8"));
	...
	public static File[] findFile() throws Exception {
		...
		try {
			...
			int j = (arrayOfString1 = its).length;
			for (int i = 0; i < j; i++) {
	...
	private static Set<String> findedPathSet = new HashSet();
