...
public class XMLConfiguration extends SourceViewerConfiguration {
	...
	protected XMLScanner getXMLScanner() {
		if (this.scanner == null) {
			...
			this.scanner.setDefaultReturnToken(
					new Token(new TextAttribute(this.colorManager.getColor(IXMLColorConstants.DEFAULT))));
		}
		return this.scanner;
	}
	...
	protected XMLTagScanner getXMLTagScanner() {
		if (this.tagScanner == null) {
			...
			this.tagScanner.setDefaultReturnToken(
					new Token(new TextAttribute(this.colorManager.getColor(IXMLColorConstants.TAG))));
		}
	...
	public org.eclipse.jface.text.presentation.IPresentationReconciler getPresentationReconciler(
		...
		NonRuleBasedDamagerRepairer ndr = new NonRuleBasedDamagerRepairer(
				new TextAttribute(this.colorManager.getColor(IXMLColorConstants.XML_COMMENT)));
